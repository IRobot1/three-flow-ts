...
export class EdgeStylesExample {
  ...
  constructor(app: ThreeJSApp) {
    ...
    timers.push(this.addLineAcross(flow, 'bezier', 'green', 3, row1))
    ...
    timers.push(this.addLineDiagonal1(flow, 'bezier', 'green', 3, row2))

    const row3 = -6
    timers.push(this.addLineDiagonal2(flow, 'step', 'blue', -3, row3))
    timers.push(this.addLineDiagonal2(flow, 'bezier', 'green', 3, row3))
