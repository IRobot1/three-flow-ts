...
const gallery: Gallery = {
  tiles: [
    ...
    { title: 'Language Graph', position: { x: 1.51, y: 0.87, z: 0 }, assetimage: 'languages', route: 'languages' },
    { title: 'Tech Tree Graph', position: { x: 1.51, y: -0.87, z: 0 }, assetimage: 'civilization', route: 'civilization' },
